      ...
      <div className="self-stretch flex flex-col justify-start items-start gap-5">
        ...
        <div className="nav-shadow self-stretch p-6 bg-white rounded-3xl  flex flex-col justify-start items-end gap-5">
          <div className="self-stretch flex flex-col justify-start items-center gap-2">
            <h1 className="self-stretch justify-center text-point text-xl font-semibold  leading-7 tracking-tight">
              Gratitude
            </h1>
            <div className="self-stretch justify-center text-black text-lg  leading-relaxed tracking-tight">
          ...
          <div className="rounded-[5px] inline-flex justify-center items-center gap-1">
            <h1 className="justify-start text-sub text-base  leading-snug tracking-tight">
              View All
            </h1>
