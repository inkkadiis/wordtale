...
export default function Library() {
  ...
  return (
    <div className="h-80p max-w-md flex flex-col self-center rounded-3xl bg-white p-6 md:p-8 shadow-lg flex flex-col gap-6 m-6">
      {/* 철자 선택 버튼 */}
      ...
      {/* 도서관 아이템 목록 */}
      {/* 단어뜻이 작을때 화살표 아이콘이 왼쪽으로 땡겨짐 */}
      <div className="flex-1 overflow-y-auto scroll-fade flex flex-col gap-3 min-h-0 scrollbar-no-arrows">
