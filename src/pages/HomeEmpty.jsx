  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 pt-10  flex flex-col gap-4">
      ...
      <div className="w-full flex flex-col justify-start items-start gap-4">
        <h1 className="text-start w-full text-black text-2xl font-medium leading-loose tracking-wide">
          Today’s Word 👑
        </h1>
        <TodayWord />
      </div>
      ...
      <div className="w-full flex flex-col justify-start items-start gap-8">
        <h1 className="text-start w-full text-black text-2xl leading-loose tracking-wide">
          Review 🔁
        </h1>
        <div className="w-full flex flex-col justify-center items-center gap-4">
          ...
          <h1 className="text-center text-sub text-lg font-semibold  leading-relaxed tracking-normal opacity-50">
            Nothing yet!
            <br />
